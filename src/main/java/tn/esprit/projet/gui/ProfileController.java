...
public class ProfileController {
    ...
    @FXML private void handleEditProfile() {
        openModal("edit_profile.fxml", "Edit Profile", 580, 660);
    }

    @FXML private void handleChangePassword() {
        openModal("change_password.fxml", "Change Password", 460, 420);
    }
    ...
    private void openModal(String fxml, String title, int w, int h) {
        try {
            ...
            // Définir le owner pour que handleClose() puisse détecter que c'est une modale
