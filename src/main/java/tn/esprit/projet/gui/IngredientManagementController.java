...
public class IngredientManagementController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        // Notification d'expiration : se déclenche uniquement à l'ouverture de la page Ingredients
        new Thread(() -> {
    ...
    public void handleSaveIngredient(ActionEvent event) {
        ...
        // Vérification expiration immédiate après sauvegarde
        new Thread(() -> ExpiryNotificationService.checkAndNotify()) {{
            setDaemon(true);
        }}.start();
    }
