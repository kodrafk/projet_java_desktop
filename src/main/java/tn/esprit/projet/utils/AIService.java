...
public class AIService {
    ...
    private static String activeModel = "gemini-2.0-flash";
    private static String API_URL = "https://generativelanguage.googleapis.com/v1/models/" + activeModel + ":generateContent?key=" + API_KEY;
    ...
    private static void discoverBestModel() {
        try {
            ...
            URL url = new URL("https://generativelanguage.googleapis.com/v1/models?key=" + API_KEY);
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
                ...
                if (models != null && models.isArray()) {
                    for (JsonNode model : models) {
                        ...
                        if (supportsGenerate && (name.contains("flash") || name.contains("pro"))) {
                            ...
                            API_URL = "https://generativelanguage.googleapis.com/v1/models/" + activeModel + ":generateContent?key=" + API_KEY;
