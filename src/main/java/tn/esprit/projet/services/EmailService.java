...
public class EmailService {
    ...
    private static final String SENDER_EMAIL = "belhassenemna61@gmail.com";
    private static final String SENDER_PASS  = "gdqg iwsb ymnc kmmm";
    ...
    private String buildEmailBody(String code) {
        return "<!DOCTYPE html><html><body style='font-family:Arial,sans-serif;background:#f4f4f4;padding:20px;'>"
             ...
             + "<h2 style='color:#2E7D32;'>NutriLife</h2>"
